 ...
 */
void EyeGame::Draw3D( const GLWindow2 &glWindow, Map &map, SE3<> se3CfromW)
{
...
/**
 * Look at the camera
 * @param nEye which eye to update
 * @param v3 location to look at
 * @param dRotLimit 
 */
