 ...
 */
void MD5::MD5Transform (unsigned long int state[4], const unsigned char block[64])
{
 ...
 * a multiple of 4.
 */
void MD5::Decode (unsigned long int *output, const unsigned char *input, unsigned int len)
{
    unsigned int i, j;
